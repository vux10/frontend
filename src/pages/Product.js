...
import { addProductToCart, deleteProduct, fetchAllProductByCategoryId, postCreateNewProduct, putUpdateProduct } from '../apis';
...
const Product = () => {
  ...
  const handleAddToCart = async (productId) => {
    ...
    const handleAddToCartData = dispatch(addProductToCart(data))
    console.log('handleAddToCartData: ', handleAddToCartData)
  }
                      ...
                      <Flex justify="space-between">
                        ...
                        >
                          ...
                          <Flex>
                            ...
                            <Button type="primary" target="_blank" onClick={() => handleAddToCart(product?._id)}>
                              Add to cart
                            </Button>
                          </Flex>
